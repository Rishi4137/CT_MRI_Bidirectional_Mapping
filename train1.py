...
hp = Hyperparameters(
    ...
    lambda_cyc=10.0,
    lambda_id=5.0,
    #checkpoint_interval = 1  # Save a checkpoint every specified number of epochs
...
def train(
    ...
    for epoch in range(hp.epoch, n_epochs):
        for i, batch in enumerate(train_dataloader):
            ...
            if(epoch%5==0 and batches_done%100==0):
                save_checkpoint(epoch, batches_done)
...
##############################################
    ...
    #checkpoint_path = "/content/MachineLearning-DeepLearning-Code-for-my-YouTube-Channel/Computer_Vision/CycleGAN_From_Scratch_PyTorch/checkpoint_epoch0_batch3.pth"
